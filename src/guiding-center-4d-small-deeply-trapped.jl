# The deeply trapped orbit of the four-dimensional guiding centre dynamics in the small tokamak equilibrium
...
module GuidingCenter4dSmallDeeplyTrappedExamples
...
const CASE = :small_deeply_trapped
