# The barely trapped orbit of the four-dimensional guiding centre dynamics in the small tokamak equilibrium
...
module GuidingCenter4dSmallBarelyTrappedExamples
    ...
    const CASE = :small_barely_trapped
