# The second Poincaré integral invariant of the four-dimensional guiding centre dynamics.
...
# samples — a surface here, a loop there — and in the figures that go with it.
...
module GuidingCenter4dPoincare2ndExamples
