# The barely passing orbit of the four-dimensional guiding centre dynamics in the small tokamak equilibrium
...
module GuidingCenter4dSmallBarelyPassingExamples
...
const CASE = :small_barely_passing
